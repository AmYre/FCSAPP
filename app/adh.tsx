		...
		<Background>
			<ScrollView contentContainerStyle={styles.scrollContainer} style={styles.container}>
				...
				<TouchableOpacity style={styles.card} onPress={() => navigation.navigate("branches")}>
					...
					<Text style={styles.description} numberOfLines={5} ellipsizeMode="tail">
						Nos équipes suivent de près les négociations et l'actualité de chaque secteur afin de porter vos voix de auprès des organisations patronales, obtenir des avancées concrètes sur
